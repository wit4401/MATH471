...
print('Trapezoidal Estimation (h=1/8): {}'.format(ex.trapezoidal_method(ex.funct6, a, b, 8)))
print('Actual Value: {}\n'.format(actualValue))
...
for val in tolerances:
    i=2
    errorTolerance=val
    err=abs(actualValue-ex.trapezoidal_method(ex.funct6, a, b, 1))
    while err >= errorTolerance:
        res=ex.trapezoidal_method(ex.funct6, a, b, i)
