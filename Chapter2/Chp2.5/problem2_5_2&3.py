...
def problem2():
    ...
    b=math.pi/2
    actualValue=1
    print('Trapezoidal Estimation (h=pi/4): {}'.format(ex.trapezoidal_method(ex.funct2, a, b, 2)))
    print('Actual Value: {}\n'.format(actualValue)) 
...
def problem3():
    ...
    b=math.pi/2
    actualValue=1
    print('Trapezoidal Estimation (h=pi/6): {}'.format(ex.trapezoidal_method(ex.funct2, a, b, 3)))
    print('Actual Value: {}\n'.format(actualValue))
    ...
    for val in tolerances:
        i=2
        errorTolerance=val
        err=abs(actualValue-ex.trapezoidal_method(ex.funct2, a, b, 1))
        while err >= errorTolerance:
            res=ex.trapezoidal_method(ex.funct2, a, b, i)
